      ...
      child: Scaffold(
        body: IndexedStack(
          ...
          children: [
            ...
            PlotListScreen(bookId: widget.book.id, authorId: widget.book.authorId, status: widget.book.status, bookName: widget.book.title,),
            CharactersListScreen(bookId: widget.book.id, authorId: widget.book.authorId, status: widget.book.status, bookName: widget.book.title,),
            EnvironmentListScreen(bookId: widget.book.id, authorId: widget.book.authorId, status: widget.book.status, bookName: widget.book.title,),
            BookNotesListBaseScreen(bookId: widget.book.id, authorId: widget.book.authorId, status: widget.book.status, bookName: widget.book.title),
          ],
        ),
